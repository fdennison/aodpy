...
BoMPresFile = 'moo-19980101-19991231.sp'
OzoneOption = 1
DefaultOzone = 0.25
OzoneFile = 'bml.o3'

ConfigFile = DataRoot + CongfigRoot + '/' + SiteCode + '.cfn'
ObsDate = datetime.date(YearMin,MonthMin,DayMin)
...
WorkPath = DataRoot + WorkPath + '/#' + str(Instrument).zfill(2) +'/'
ResultPath = WorkPath
DataType = Extension

if PressureOption == 3:
    if os.path.isfile(BoMPresFile):
        print(f'BoM pressure file={BoMpresFile}')
    else:
        print('No BoM pressure file')

if os.path.isfile(BoMPresFile):
    print(f'Ozone file={OzoneFile}')
else:
    print('No Ozone file')
...
GenFile = WorkPath + FileRoot + '.gen'
print('*** General regression analysis ***')
print(f'Tabulation file: {GenFile}')
